...
const ICONOS = {
  ...
  editar: <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5z" />,
  eliminar: (
    <>
 ...
 * Uso: <Icon nombre="gasto" size={20} />
 */
export function Icon({ nombre, size = 20, className = '' }) {
  return (
    <svg
